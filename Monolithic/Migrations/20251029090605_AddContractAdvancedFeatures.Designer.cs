...
namespace Monolithic.Migrations
{
    ...
    [Migration("20251029090605_AddContractAdvancedFeatures")]
    partial class AddContractAdvancedFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Monolithic.Models.ContractArchival", b =>
                {
                    b.Property<Guid>("ArchivalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");
                    ...
                    b.HasIndex("IsPermanentlyDeleted");

                    b.HasIndex("RenterId");

                    b.HasIndex("ScheduledForDeletionAt");

                    b.ToTable("ContractArchives");
                });

            modelBuilder.Entity("Monolithic.Models.ContractTermination", b =>
                {
                    ...
                    b.Property<string>("TerminatedFromIp")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("TerminatedUserAgent")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");

                    b.Property<string>("TerminationInitiator")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Monolithic.Models.ContractTerminationEvidence", b =>
                {
                    ...
                    b.ToTable("ContractTerminationEvidences");
                });

            modelBuilder.Entity("Monolithic.Models.ContractToken", b =>
                {
                    ...
                    b.Property<bool>("IsUsedForSigning")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Monolithic.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 29, 9, 6, 5, 200, DateTimeKind.Utc).AddTicks(1699),
            ...
            modelBuilder.Entity("Monolithic.Models.ContractTerminationEvidence", b =>
                {
                    b.HasOne("Monolithic.Models.ContractTermination", null)
