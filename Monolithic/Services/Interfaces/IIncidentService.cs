...
namespace Monolithic.Services.Interfaces
{
    public interface IIncidentService
    {
        ...
        Task<IncidentListResponse> GetIncidentsAsync(Guid? stationId, string? status, DateTime? dateFrom, DateTime? dateTo, int page, int pageSize, Guid userId, string userRole);
