...
export default function BookingHistory(){
  ...
  const getBookingStatus = (status) => {
    const statuses = {
      ...
      2: { text: 'Wait for check-in-payment', class: 'status-wait-for-check-in-payment' },
      // 3: { text: 'Cancelled', class: 'status-cancelled' },
      3: { text: 'In-use', class: 'status-in-use' },
      4: { text: 'Wait for check-out', class: 'status-wait-for-check-out' },
      5: { text: 'Completed', class: 'status-completed' },
      6: { text: 'Cancel-pending-refund', class: 'status-cancel-pending-refund' },
