...
export default function BookingCard({ booking, onClick }) {
  ...
  else if (booking.status === 'contracted') cls += 'booking-status-contracted';
  else if (booking.status === 'checked-in') cls += 'booking-status-checked-in';
  else if (booking.status === 'on-going') cls += 'booking-status-on-going';
